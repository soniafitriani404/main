...
CREATE TABLE umkm(
	...
	tanggal_regristasi DATE,`data_umkm_jabar` RESTRICT ON UPDATE CASCADE,
...
-- Data untuk UMKM
INSERT INTO umkm (nama_usaha, id_pemilik, id_kategori, id_skala, id_kabupaten_kota, alamat_usaha, nik, npwp, tahun_berdiri, jumlah_karyawan, total_aset, omzet_per_tahun, deskripsi_usaha, tanggal_regristasi) VALUES
...
INSERT INTO produk_umkm (nama_produk, deskripsi_produk, harga) VALUES
('Sambel Hejo Level 1', 'Sambel hejo dengan tingkat kepedasan rendah', 15000),
('Sambel Hejo Level 3', 'Sambel hejo dengan tingkat kepedasan sedang', 17000),
( 'Sambel Hejo Level 5', 'Sambel hejo dengan tingkat kepedasan tinggi', 20000),
( 'Ayam Goreng Sambel Hejo', 'Paket nasi dengan ayam goreng dan sambel hejo', 25000),
( 'Batik Tulis Mega Mendung', 'Batik tulis motif mega mendung khas Cirebon', 750000),
( 'Batik Cap Kujang', 'Batik cap dengan motif kujang', 350000),
( 'Kemeja Batik Pria', 'Kemeja batik pria lengan panjang', 275000),
( 'Dress Batik Modern', 'Dress batik modern untuk wanita', 325000),
( 'Keranjang Anyaman Bambu', 'Keranjang anyaman bambu multi fungsi', 85000),
( 'Topi Anyaman Bambu', 'Topi anyaman bambu untuk bertani', 45000),
( 'Vas Bunga Rotan', 'Vas bunga dari rotan dengan desain klasik', 120000),
( 'Jeruk Keprok 1 kg', 'Jeruk keprok segar langsung dari kebun', 30000),
( 'Mangga Gedong Gincu 1 kg', 'Mangga gedong gincu khas Indramayu', 45000),
( 'Telur Ayam Kampung 1 kg', 'Telur ayam kampung organik', 60000),
( 'Ayam Potong Segar 1 ekor', 'Ayam potong segar', 75000),
( 'Ikan Nila Segar 1 kg', 'Ikan nila segar hasil budidaya', 40000),
( 'Ikan Mas Segar 1 kg', 'Ikan mas segar hasil budidaya', 45000),
( 'Pempek Ikan', 'Pempek ikan nila homemade', 60000),
( 'Jasa Las Teralis', 'Jasa pembuatan teralis per meter', 350000),
( 'Jasa Las Pagar', 'Jasa pembuatan pagar besi per meter', 450000),
( 'Paket Sembako Hemat', 'Paket sembako hemat (beras, minyak, gula)', 150000),
( 'Beras Premium 5 kg', 'Beras premium kualitas terbaik', 75000),
( 'Meja Makan Set', 'Set meja makan kayu jati dengan 6 kursi', 12500000),
( 'Lemari Pakaian 3 Pintu', 'Lemari pakaian 3 pintu dari kayu jati', 8500000),
( 'Jasa Pembuatan Website', 'Jasa pembuatan website profesional', 5000000),
( 'Jasa Pembuatan Aplikasi Mobile', 'Jasa pembuatan aplikasi mobile Android dan iOS', 15000000),
( 'Kamar Standar per Malam', 'Sewa kamar standar per malam termasuk sarapan', 350000),
( 'Kamar Superior per Malam', 'Sewa kamar superior per malam termasuk sarapan', 500000),
( 'Jasa Desain Logo', 'Jasa pembuatan desain logo perusahaan', 2500000),
( 'Jasa Branding Komprehensif', 'Jasa branding komprehensif (logo, kop surat, dll)', 7500000),
( 'Dodol Garut', 'Dodol khas Garut berbagai rasa', 25000),
( 'Opak Singkong', 'Opak singkong khas Purwakarta', 20000),
( 'Syal Rajutan', 'Syal rajutan tangan dengan benang wol premium', 150000),
( 'Topi Rajutan Bayi', 'Topi rajutan untuk bayi', 75000),
( 'Kopi Arabika Gunung Puntang 250gr', 'Kopi arabika premium dari Gunung Puntang', 125000),
( 'Kopi Robusta Gunung Papandayan 250gr', 'Kopi robusta premium dari Gunung Papandayan', 95000);
