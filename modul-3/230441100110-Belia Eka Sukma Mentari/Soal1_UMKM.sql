...
CALL AddUMKM('Kopi Warung Kita', 5);
SELECT * FROM umkm;

#no2
DELIMITER //

CREATE PROCEDURE UpdateKategoriUMKM (IN p_id_kategori INT, IN p_nama_baru VARCHAR(100))
...
BEGIN
    -- Hapus produk UMKM yang terkait
...
CALL AddProduk(3, 'Keripik Pisang', 15000.00);
SELECT * FROM produk_umkm;
